...
<a href="https://agent-cdn.minimax.io/cdn_upload/20260515/401093546773143555/377264959930469/043935_b6de/workspace/store/Product_07_Lead_Gen_System_v1.0.zip" download style={{display:'block',textAlign:'center',backgroundColor:'rgba(99,102,241,0.1)',color:IND3,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,border:'1px solid rgba(99,102,241,0.25)',fontFamily:'system-ui,sans-serif'}}>Get the Lead Gen Kit — Download</a>
</div>
...
<a href="https://agent-cdn.minimax.io/cdn_upload/20260515/401093546773143555/377264959930469/043935_b6de/workspace/store/Product_07_Lead_Gen_System_v1.0.zip" download style={{display:'block',textAlign:'center',backgroundColor:IND,color:W,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,fontFamily:'system-ui,sans-serif'}}>Get the Complete System — Download</a>
</div></div>

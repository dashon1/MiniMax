...
const C='#0f172a';const C2='#1e293b';const CYAN='#06b6d4';const W='#ffffff';const GY='#94a3b8';const GY2='#64748b'
const files=[{name:'01_AI_Workflow_Quickstart.md',size:'8.4 KB',desc:'System overview, 5 automation types, and setup plan'},{name:'02_Zapier_Automation_SOP.md',size:'14.2 KB',desc:'Step-by-step for building all 5 automations in Zapier'},{name:'03_AI_Prompt_Frameworks.md',size:'11.8 KB',desc:'8 AI prompt templates for workflow automation'},{name:'04_Notion_Workflow_Tracker.md',size:'9.6 KB',desc:'Project tracking system built in Notion'},{name:'05_Checklist_Review_System.md',size:'7.4 KB',desc:'Quality control checklist for automated outputs'}]
const feat=[{i:'⚡',t:'5 Workflow Automations',d:'Email to task, meeting to summary, content to archive, invoice to tracker, report generator.'},{i:'🧠',t:'8 AI Prompt Frameworks',d:'Prompt templates that turn ChatGPT into your automation co-pilot for every workflow.'},{i:'📋',t:'Notion Workflow Tracker',d:'A live dashboard showing every active workflow, its status, and what needs attention.'},{i:'✅',t:'Automated QA Checklist',d:'Every automated output gets checked against a 10-point quality checklist automatically.'},{i:'🔌',t:'Zapier-Native Setup',d:'Built for Zapier. Free tier works. Each automation is a step-by-step visual guide.'},{i:'📊',t:'Weekly Digest Report',d:'Every Monday: one email with your week accomplishments and outstanding tasks.'}]
const starter=['Quickstart Guide + Workflow Overview','5 Automation SOPs (step-by-step)','8 AI Prompt Frameworks','Notion Workflow Tracker Template','48-hour email support']
const complete=['Everything in Starter','Pre-built Zapier import bundle (all 5 Zaps)','Notion Dashboard Template (import-ready)','Weekly Digest Report automation','Priority 24h support']
const faqs=[{q:'Do I need to know how to code?',a:'No. All automations are built in Zapier using no-code triggers and actions. The AI prompt frameworks work in ChatGPT or Claude.'},{q:'Do I need a paid Zapier account?',a:'The free Zapier tier (100 tasks/month) covers 4 of 5 automations. Weekly Digest requires Pro ($20/month). Start free, upgrade when needed.'},{q:'What AI models does this work with?',a:'All prompt frameworks work with ChatGPT, Claude, and Gemini. No special API required.'},{q:'How is this delivered?',a:'Instant digital download. ZIP with all 5 files and link to the Notion template. No physical product.'},{q:'Is there a refund?',a:'Digital products are non-refundable once downloaded. If files are corrupted, contact us and we will resolve it immediately.'},{q:'Can I resell this kit?',a:'No. This is licensed for personal use only. You may not resell, redistribute, or sublicense this product in any form.'}]
const automations=[{n:'#1',t:'Email to Task',d:'New email detected, task created in Notion, notification sent. No more follow-up slip-through.'},{n:'#2',t:'Meeting to Summary',d:'Calendar event ends, AI generates summary, sent to Notion and email to you. Meeting notes you actually read.'},{n:'#3',t:'Content to Archive',d:'Content published, logged to Notion with date, platform, and link. Your content library stays clean.'},{n:'#4',t:'Invoice to Tracker',d:'Invoice email received, amount and vendor extracted, logged to finance tracker. No manual entry.'},{n:'#5',t:'Weekly Report',d:'Every Monday 8am, Zapier pulls your week tasks, formats a digest, emails it to you. Start the week informed.'}]
...
<p style={{fontSize:19,color:GY,lineHeight:1.7,marginBottom:12,fontFamily:'system-ui,sans-serif'}}>5 pre-built automations that turn scattered tasks into a connected system. Email to task. Meeting to summary. Content to archive. Invoices tracked automatically.</p>
...
<div><div style={{fontWeight:700,fontSize:14,marginBottom:4,fontFamily:'system-ui,sans-serif',color:W}}>{f.name}</div><div style={{color:GY,fontSize:12,marginBottom:4,fontFamily:'system-ui,sans-serif'}}>{f.desc}</div><div style={{color:CYAN,fontSize:11,fontFamily:'system-ui,sans-serif'}}>{f.size}</div></div></div>))}
</div>
<div>
...
<p style={{color:GY2,fontSize:15,lineHeight:1.7,marginBottom:16,fontFamily:'system-ui,sans-serif'}}>You manually create tasks from emails. You take your own meeting notes. You update your Notion every week when you remember. Things slip through. Work does not get logged.</p>
...
{[{n:'01',t:'Trigger',d:'Something happens in your tools: an email arrives, a meeting ends, content goes live.'},{n:'02',t:'Filter',d:'Zapier checks conditions. Is it the right type? The right time? The right project?'},{n:'03',t:'Action',d:'If conditions are met, Zapier does the work: create a task, log a note, send a summary.'}].map(s=>(
...
<ul style={{listStyle:'none',padding:0,marginBottom:32}}>{starter.map(item=>(<li key={item} style={{display:'flex',gap:10,marginBottom:12,fontSize:14,alignItems:'flex-start'}}><span style={{color:CYAN,flexShrink:0,fontWeight:700}}>✓</span><span style={{color:W}}>{item}</span></li>))}</ul>
<a href="https://agent-cdn.minimax.io/cdn_upload/20260515/401093546773143555/377264959930469/030402_2db7/workspace/store/Product_01_AI_Workflow_Kit_v1.0.zip" download style={{display:'block',textAlign:'center',backgroundColor:'rgba(6,182,212,0.1)',color:CYAN,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,border:'1px solid rgba(6,182,212,0.25)',fontFamily:'system-ui,sans-serif'}}>Get the Workflow Kit</a>
</div>
...
<ul style={{listStyle:'none',padding:0,marginBottom:32}}>{complete.map(item=>(<li key={item} style={{display:'flex',gap:10,marginBottom:12,fontSize:14,alignItems:'flex-start'}}><span style={{color:CYAN,flexShrink:0,fontWeight:700}}>✓</span><span style={{color:W}}>{item}</span></li>))}</ul>
<a href="https://agent-cdn.minimax.io/cdn_upload/20260515/401093546773143555/377264959930469/030402_2db7/workspace/store/Product_01_AI_Workflow_Kit_v1.0.zip" download style={{display:'block',textAlign:'center',backgroundColor:CYAN,color:W,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,fontFamily:'system-ui,sans-serif'}}>Get the Complete System</a>
</div></div>

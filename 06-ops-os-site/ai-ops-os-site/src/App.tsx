...
<a href="https://agent-cdn.minimax.io/cdn_upload/20260515/401093546773143555/377264959930469/040353_f9e4/workspace/store/Product_06_AI_Ops_OS_v1.0.zip" download style={{display:'block',textAlign:'center',backgroundColor:'rgba(249,115,22,0.1)',color:CO,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,border:'1px solid rgba(249,115,22,0.25)',fontFamily:'system-ui,sans-serif'}}>Get the Ops OS Kit</a>
</div>
...
<a href="https://agent-cdn.minimax.io/cdn_upload/20260515/401093546773143555/377264959930469/040353_f9e4/workspace/store/Product_06_AI_Ops_OS_v1.0.zip" download style={{display:'block',textAlign:'center',backgroundColor:CO,color:W,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,fontFamily:'system-ui,sans-serif'}}>Get the Complete OS</a>
</div></div>

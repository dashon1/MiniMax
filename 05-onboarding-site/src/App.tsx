...
<a href="#" style={{display:'block',textAlign:'center',backgroundColor:'rgba(20,184,166,0.1)',color:TEAL3,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,border:'1px solid rgba(20,184,166,0.25)',fontFamily:'system-ui,sans-serif'}}>Get the Onboarding Kit</a>
</div>
...
<a href="#" style={{display:'block',textAlign:'center',backgroundColor:TEAL,color:WHITE,padding:'14px',borderRadius:10,textDecoration:'none',fontWeight:700,fontSize:15,fontFamily:'system-ui,sans-serif'}}>Get the Complete Kit</a>
</div></div>
